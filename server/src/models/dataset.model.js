...
const datasetSchema = new mongoose.Schema({
  ...
  source: { type: String, enum: ["CNEOS_SCOUT", "NASA_DONKI_CME"], required: true, immutable: true },
  sourceType: { type: String, enum: ["NASA_API"], required: true, immutable: true },
  sourceUri: { type: String, required: true, immutable: true },
  datasetType: { type: String, enum: ["NEO_HAZARD_ASSESSMENT", "SPACE_WEATHER"], required: true, immutable: true },
